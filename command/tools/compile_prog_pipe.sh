...
BIN="prog_pipe"
CFLAGS="-std=gnu99 -Wall -c -fno-builtin -W -Wmissing-prototypes -Wsystem-headers"
LIBS="-I ../lib -I ../lib/kernel -I ../lib/user -I ../kernel -I ../fs -I ../device -I ../thread -I ../userprog -I ../fs -I ../shell"
